...
import vn.iuh.edu.fit.labweek05.backend.services.impl.CustomUserDetailImpl;
...
public class SecurityConfiguration {
    ...
    // Tự động tiêm (inject) 1 triển khai của UserDetailsService
    @Autowired
    public SecurityConfiguration(CustomUserDetailImpl customUserDetailImpl) {
        this.customUserDetailImpl = customUserDetailImpl;
    }
//    @Autowired
...
//                        .defaultSuccessUrl("/candidates/profile", true)
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        ...
        auth.setUserDetailsService(customUserDetailImpl);
